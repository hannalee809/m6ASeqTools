...
dir_descriptive <- file.path(output_dir, "descriptive_statistics")
dir_annotations <- file.path(output_dir, "external_annotations")
dir_comparisons <- file.path(output_dir, "comparative_analysis")

# Create directories if they don't exist
dirs <- c(output_dir, dir_descriptive, dir_annotations, dir_comparisons)
...
```{r summarize-m6anet-output, message=FALSE, warning = FALSE}
...
# save output
write.csv(filtered_m6A_naive_gli36_cells, file.path(dir_descriptive, "naive_filtered_m6A_sites.csv"))
```
...
# Save output
write.csv(naive_m6A_with_tx_annotations, file.path(dir_descriptive,"naive_m6A_with_tx_annotations.csv"))
ggsave("naive_tx_density.pdf", p)
```
...
chr <- calculate_chromosome_location(filtered_m6A_naive_gli36_cells,
                              output_csv=file.path(dir_descriptive,"chromosomal_distribution.csv"), 
                              output_plot=file.path(dir_descriptive,"naive_chr_distribution.png"))
...
head(annotated_example_naive_with_rbp$annotated_m6A_df)
```
