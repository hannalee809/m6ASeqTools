...
If you study contains replicates, you can use this function to conduct a Wilcoxin Signed-Rank Test to statistically validate whether a transcript is hypermethylated in one group vs the other. For this analysis, make sure you have the weighted modification ratio results from the **unfiltered** m6A dataframe with transcript regions if you choose. Unlike the previous function, this function requires raw unfiltered m6A sites in order to ... 
