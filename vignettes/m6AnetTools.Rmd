...
# File paths
rbp_file <- system.file("extdata", "RBP_POSTAR_human_subset.bed", package = "m6AnetTools")
snp_file <- system.file("extdata", "dbSNP_human_subset.bed", package = "m6AnetTools")
...
colnames(rbp_df) <- c(
  ...
  "strand",       # +/-
  "RBP_name",          # RBP name
  "experiment_method",  # Measure of enrichment for the region
  "sample",       # pvalue
  "accession_of_raw_data",    # accession number
